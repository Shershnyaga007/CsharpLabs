...
{
    public partial class Жиролятор : Form
    {
        ...
        private SoundPlayer truba;
        private SoundPlayer woo;

        public Жиролятор()
        {
            InitializeComponent();
            
            soundPlayer = new SoundPlayer("uwu.wav");
            truba = new SoundPlayer("truba.wav");
            woo = new SoundPlayer("woo.wav");
        }
        ...
        private void buttonEquals_Click(object sender, EventArgs e)
        {
            ...
            switch (Operation)
            {
                ...
                case "/":
                    if(opr2 == 0)
                    {
                        MessageBox.Show("Дурак? Деление на 0 запрещено!");
                    }
                    else
                    {
                        Result = (opr1 / opr2).ToString();
